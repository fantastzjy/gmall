...
public class TestOauth2 {
    ...
    public static String getAccess_token(){
        ...
        paramMap.put("code","778f160cba532fa3011959d48d64c9ba");// 授权有效期内可以使用，每新生成一次授权码，说明用户对第三方数据进行重启授权，之前的access_token和授权码全部过期
    ...
    public static Map<String,String> getUser_info(){
        ...
        String s4 = "https://api.weibo.com/2/users/show.json?access_token=2.00uPawPI0p5_hM60101a8450HucFFB&uid=7564670090";
