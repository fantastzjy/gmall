...
public class PaymentController {
    ...
    @ResponseBody
    public String alipayJiade(String outTradeNo, BigDecimal totalAmount, HttpServletRequest request, ModelMap modelMap) {
        ...
        //map.put("subject", "感光徕卡Pro300瞎命名系列手机");
        ...
        String trade_no = UUID.randomUUID().toString();
        //String out_trade_no = request.getParameter("out_trade_no");
        String out_trade_no = outTradeNo;
        //String trade_status = request.getParameter("trade_status");
        String trade_status = "支付宝已支付";
        //String total_amount = request.getParameter("total_amount");
        String total_amount = totalAmount.toString();
        //String subject = request.getParameter("subject");
        String subject = "谷粒商城商品一件";
        //String call_back_content = request.getQueryString();
        String call_back_content = "支付完啦";
